...
public class RfbBootstrap implements CommandLineRunner {
    ...
    private void initData() {
        ...
        authorityRepository.save(new Authority().name("ROLE_ORGANIZER"));
        authorityRepository.save(new Authority().name("ROLE_RUNNER"));

        User rfbUser = new User();
        rfbUser.setLogin("arunm");
        rfbUser.setFirstName("Arun");
        rfbUser.setActivated(true);
        rfbUser.setPassword(passwordEncoder.encode("arunm"));
        rfbUser.setAuthorities(new HashSet<>(authorityRepository.findAll()));
    ...
    private RfbEvent getRfbEvent(RfbLocation rfbLocation) {
        ...
        rfbEvent.setEventCode(String.format("%04d", new Random().nextInt(10000)));
